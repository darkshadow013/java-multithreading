...
public class CustomSchedulerService {
     ...
     * subsequently with the given period; that is executions will commence after
     * initialDelay then
    ...
    public static void main(String[] args) {
        ...
        schedulerService.scheduleWithFixedDelay(task3, 1, 100, TimeUnit.MILLISECONDS);
        Runnable task4 = getRunnableTask("Task4");
        // schedulerService.scheduleAtFixedRate(task4, 1, 100, TimeUnit.MILLISECONDS);
